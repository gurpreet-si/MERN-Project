    ...
    return (
        <div>
                ...
                <div className='py-48 flex flex-col justify-center items-center gap-8'>
                    ...
                    <div className='text-center space-y-7 px-4'>
                        ...
                        <p className='text-xl text-[#4A4A4A] md:w-4/5 mx-auto'>
                            Come with family & feel the joy of mouthwatering food such as Greek Salad, Lasagne, Butternut Pumpkin, Tokusen Wagyu, Olivas Rellanas and more for a moderate cost
                        </p>
            ...
            <div className='section-container'>
                {/* filterind and sorting */}
                <div className='flex flex-row md: flex-row flex-wrap md:justify-between items-center space-y-2 mb-12'>
                    {/* all category btns */}
                    ...
                    <div className='flex justify-end mb-4 rounded-sm mb-12'>
                ...
                <div className="grid md:grid-cols-3 sm:grid-cols-1 grid-cols-3 gap-4">     
                {
