        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-12'>
             ...
             <div className='md:w-1/2'>
                <div className='text-left md:w-4/5'>
                    ...
                    <p className='my-5 text-seceondary leading-[40px]'>
                        "Rooted in passion, we curate unforgottable dining experiences and offer exceptional services, blending culinary artistry with warm hospitality."
                    </p>      
